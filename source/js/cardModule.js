...
//:TODO Change structure of Facs and Caths rooms in .py
    ...
    fillCathedraTemplate() {
      ...
      Object.keys(this.buildingData.cath).forEach((cathedra) => {
        ...
        this.buildingData.cath[cathedra].forEach((room) => {
          ...
          cathedraFragment.querySelector(`.info__rooms-list`).appendChild(roomFragment);
        })
    ...
    fillFacsTemplate() {
      ...
      Object.keys(this.buildingData.facs).forEach((fac) => {
        ...
        this.buildingData.facs[fac].forEach((room) => {
          ...
          roomFragment.className = `info__rooms-list-item`;
          roomFragment.textContent = `${room}`;
          facFragment.querySelector(`.info__rooms-list`).appendChild(roomFragment);
        })
